...
Route::group(['prefix' => 'vue-guard', 'middleware' => ['web','auth:api']], function() {
    ...
    Route::get('/{id}/edit', 'Bantenprov\VueGuard\Http\Controllers\VueGuardController@edit')->name('vueguard.edit');

    Route::put('/{id}/update', 'Bantenprov\VueGuard\Http\Controllers\VueGuardController@update')->name('vueguard.update');
